    ...
    <section className="relative overflow-hidden rounded-[30px] border border-white/70 bg-white/80 p-6 shadow-card backdrop-blur">
      ...
      <div className="relative flex flex-col items-center gap-5 sm:flex-row sm:items-center">
        <div className="relative">
          <div className="flex h-28 w-28 items-center justify-center rounded-full bg-gradient-to-br from-indigo-600 to-blue-500 text-3xl font-extrabold text-white shadow-xl shadow-indigo-200">
            NA
          </div>
          <button
            type="button"
        ...
        <div className="text-center sm:text-left">
          <h2 className="text-2xl font-extrabold text-slate-950">Nguyễn Văn A</h2>
